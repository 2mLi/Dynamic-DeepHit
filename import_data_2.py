...
def import_dataset(path, norm_mode = 'standard'):
    ...
    bin_list           = ['Gender', 'Asc']
    cont_list          = [ 'Afp', 'Age', "Alt", "Ast", "Ygt", 'Alb', 'Plt', 'Tb']
    ...
    df_['Alt'] = np.log10(df_['Alt'] + 0.00001)
    df_['Ast'] = np.log10(df_['Ast'] + 0.00001)
    df_['Ygt'] = np.log10(df_['Ygt'] + 0.00001)
    df_['Alb'] = np.log10(df_['Alb'] + 0.00001)
    df_['Plt'] = np.log10(df_['Plt'] + 0.00001)
    df_['Tb'] = np.log10(df_['Tb'] + 0.00001)
